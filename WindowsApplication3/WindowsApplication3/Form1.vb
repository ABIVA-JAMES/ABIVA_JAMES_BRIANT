Public Class Form1
    ...
    Private Sub total_txtbox_TextChanged(sender As Object, e As EventArgs) Handles total_txtbox.TextChanged
    ...
    Private Sub eigth_btn_Click(sender As Object, e As EventArgs) Handles eigth_btn.Click
        total_txtbox.Text = total_txtbox.Text & sender.Text
    End Sub
    ...
    Private Sub two_btn_Click_1(sender As Object, e As EventArgs) Handles two_btn.Click
        total_txtbox.Text = total_txtbox.Text & sender.Text
